...
function completeLevel(perfect) {
    ...
    try {
        localStorage.setItem('mobholdLevelScores', JSON.stringify(levelHighScores));
        localStorage.setItem('mobholdMaxLevel', maxLevelReached.toString());
    } catch (e) {}
...
async function loadGameData() {
    ...
    try {
        ...
        if (savedLevelScores) {
            levelHighScores = JSON.parse(savedLevelScores);
        }
